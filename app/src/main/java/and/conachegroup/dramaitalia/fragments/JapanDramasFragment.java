...
public class JapanDramasFragment extends Fragment implements SearchView.OnQueryTextListener {
    ...
    private class JapanDramasAdapter
        ...
        @Override
        public JapanDramasAdapter.JapanDramaViewHolder onCreateViewHolder(ViewGroup parent,
                                                                          int viewType) {
            View view =
        ...
        @Override
        public void onBindViewHolder(JapanDramasAdapter.JapanDramaViewHolder holder, int position) {
