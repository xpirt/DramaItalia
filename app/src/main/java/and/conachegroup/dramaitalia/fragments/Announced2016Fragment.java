...
public class Announced2016Fragment extends Fragment implements SearchView.OnQueryTextListener {
    ...
    private class Announced2016Adapter
        ...
        @Override @NonNull
        public Announced2016Adapter.Announced2016ViewHolder onCreateViewHolder(@NonNull ViewGroup parent,
                                                                                   int viewType) {
        ...
        @Override
        public void onBindViewHolder(@NonNull Announced2016Adapter.Announced2016ViewHolder holder,
                                     int position) {
